...
#### Hardware Used:   
L298N Driver, Raspberry Pi Camera, Raspberry Pi Computer, Double AA Batteries, SD Card, Motors, Chassis, Dupont Wires.  
...
libgpiod – Controls the L298N motor driver via Raspberry Pi GPIO pins.  
