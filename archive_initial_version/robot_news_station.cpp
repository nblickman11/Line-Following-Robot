...
public:
    ...
    {
        // publisher remains alive as long as something is pointing to it.
        // create publisher is method from rcl library that publishes messages of certain data type
